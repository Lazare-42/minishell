...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/01/04 11:57:36 by lazrossi          #+#    #+#             */
/*   Updated: 2018/01/04 11:59:13 by lazrossi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**    {
**    (*new)->arg =
** ft_strjoinfree_str_char(&(*new)->arg, (*new)->line_right[0]);
**    (*new)->line_right =
** ft_strdupfrom_free((const char**)&((*new)->line_right), 1);
**    }
**    }
**
** int			operate_special_input
** (t_arg **new, char *buf, t_arg **first, int fd)
** {
** 	if (buf[0] == '\n')
** 		operate_cr(new, first);
** 	else if (buf[0] == 127 && (*new)->arg && *(*new)->arg)
